...
#NOTE: Wait for 15 mins before invoking any APIs. intermittently we get Server Error with no information.
#      May be lamda provisioning is taking time.
